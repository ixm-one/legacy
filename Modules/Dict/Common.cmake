...
function (ixm_dict_codes)
  ...
  string(ASCII 3 end-of-text)
  string(ASCII 2 start-of-text)
  set(+NEL ${newline} CACHE INTERNAL "C1 New Line Control Code")
  set(+STX ${start-of-text} CACHE INTERNAL "C0 Start of Text Control Code")
  set(+ETX ${end-of-text} CACHE INTERNAL "C0 End of Text Control Code")
  ...
  set(+C0 ${invalid} CACHE INTERNAL "Don't ask me about anything, I don't know")
  mark_as_advanced(FORCE +NEL)
  mark_as_advanced(FORCE +STX)
  mark_as_advanced(FORCE +ETX)
