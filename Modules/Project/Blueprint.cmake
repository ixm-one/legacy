...
function (ixm_project_blueprint_find name)
  ...
  foreach (path IN LISTS paths)
    if (EXISTS "${path}")
      ...
      set_property(GLOBAL PROPERTY ixm::blueprint::name ${name})
      return()
    endif()
  endforeach()
...
function (ixm_project_blueprint_load name)
  ...
  get_property(file GLOBAL PROPERTY ixm::blueprint::file)
  get_property(path GLOBAL PROPERTY ixm::blueprint::name)

  dict(ASSIGN ${PROJECT_NAME}::blueprint FILE "${file}")
  dict(ASSIGN ${PROJECT_NAME}::blueprint NAME "${name}")
