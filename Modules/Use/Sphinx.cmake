...
function (add_documentation name type)
  ...
  genex(COMPILE_OPTIONS $<
    $<BOOL:$<TARGET_PROPERTY:${name},INTERFACE_COMPILE_OPTIONS>>:
    $<JOIN:$<TARGET_PROPERTY:${name},INTERFACE_COMPILE_OPTIONS>,$<SEMICOLON>>
  >)
  genex(SOURCES $<
    $<BOOL:$<TARGET_PROPERTY:${name},INTERFACE_SOURCES>>:
    $<TARGET_PROPERTY:${name}:INTERFACE_SOURCES>
  >)
