...
function (log level)
  ...
  if (level STREQUAL "TRACE" AND current IN_LIST ixm::log::trace)
    return()
...
function (ixm_log_file timestamp level message)
  aspect(GET path:log AS directory)
  file(APPEND "${directory}/${PROJECT_NAME}.log" "[${timestamp}] ${level}: ${message}\n")
endfunction()